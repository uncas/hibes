                    ...
                    <InsertItemTemplate>
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="tbStart" runat="server" Text='<%# Bind("StartDate") %>'></asp:TextBox>
                                </td>
                                <td>
                                    <asp:TextBox ID="tbEnd" runat="server" Text='<%# Bind("EndDate") %>'></asp:TextBox>
                                </td>
                                <td>
            ...
            <div id="divTasks">
                <asp:GridView ID="gvTasks" runat="server" DataSourceID="odsTasks" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <uncas:BoundFieldResource HeaderResourceName="Begin" DataField="StartDate" HtmlEncode="false"
                            DataFormatString="{0:d}" />
                        <uncas:BoundFieldResource HeaderResourceName="End" DataField="EndDate" HtmlEncode="false"
                            DataFormatString="{0:d}" />
